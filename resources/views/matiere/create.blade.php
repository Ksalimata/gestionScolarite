...
<div class="col-md-6">
	<form action="{{route('matiere.store')}}" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="code_matiere" name="code_matiere" aria-describedby="emailHelp">
	  </div>
	  <div class="form-group">
	    <label>Libellé de la matière</label>
	    <input type="text" class="form-control" id="libelle_matiere" name="libelle_matiere">
	  </div>
