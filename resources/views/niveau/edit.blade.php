		...
		<div class="col-md-6">
			<form action="{{route('niveau.update', $niveau->id)}}" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="code_niveau" name="code_niveau" value="{{$niveau->code_niveau}}" aria-describedby="emailHelp">
			  </div>
			  <div class="form-group">
			    <label>Libellé du niveau</label>
			    <input type="text" class="form-control" id="libelle_niveau" name="libelle_niveau" value="{{$niveau->libelle_niveau}}">
			  </div>
