		...
		<div class="col-md-6">
			<form action="{{route('filiere.update', $filiere->id)}}" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="code_filiere" name="code_filiere" value="{{$filiere->code_filiere}}" aria-describedby="emailHelp">
			  </div>
			  <div class="form-group">
			    <label>Libellé de la filière</label>
			    <input type="text" class="form-control" id="libelle_filiere" name="libelle_filiere" value="{{$filiere->libelle_filiere}}">
			  </div>
